...
<header class="page-header">
    <h2 class="page-title mt-0 mb-2">New Prescriptions Template</h2>
</header>
<hr class="my-2"/>
<div class="page-content">
    <div class="row">
        <div class="col-md-12 mb-5">
            <form method="POST" action="{{ route('admin.prescriptions-templates.store') }}">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="mt-0">Prescription Info</h4>
                        <div class="prescription-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="title">Title</label>
                                        <input type="text" name="title" class="form-control" placeholder="Write Something..." value="{{ old('title') }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="concern">Major Concern</label>
                                        <textarea class="form-control" name="chief_complain" id="concern" cols="30" rows="1" placeholder="Write Something...">{{ old('chief_complain') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table medicines-table table-sm">
                                ...
                                <tbody id="medicine-items">
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control form-control-sm medicine-type" type="text" name="type[]" list="mtypes" placeholder="Medicine Type">
                                            <datalist id="mtypes">
                                        ...
                                        <td>
                                            <input class="form-control form-control-sm" type="text" name="quantity[]" placeholder="Dosing" list="dosing" autocomplete="off">
                                            <datalist id="dosing">
